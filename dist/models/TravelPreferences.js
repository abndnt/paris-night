...
exports.TravelPreferencesModel = void 0;
class TravelPreferencesModel {
    constructor(database) {
        this.db = database;
    }
    async create(preferencesData) {
        const { userId, preferredAirlines = [], preferredAirports = [], seatPreference, mealPreference, maxLayovers = 2, preferredCabinClass = 'economy' } = preferencesData;
        const query = `
    ...
    async update(userId, updateData) {
        const { preferredAirlines, preferredAirports, seatPreference, mealPreference, maxLayovers, preferredCabinClass } = updateData;
        const query = `
...
exports.TravelPreferencesModel = TravelPreferencesModel;
//# sourceMappingURL=TravelPreferences.js.map