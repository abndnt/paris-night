...
exports.validateCompleteBooking = validateCompleteBooking;
class BookingValidator {
    static validatePassengers(passengers) {
        const errors = [];
        const warnings = [];
    ...
    static validateCostBreakdown(costBreakdown) {
        const errors = [];
        const warnings = [];
        if (!costBreakdown) {
            errors.push({
    ...
    static validateFlightAvailability(flightDetails) {
        const errors = [];
        const warnings = [];
        if (!flightDetails) {
            errors.push({
...
function validateCompleteBooking(passengers, paymentInfo, costBreakdown, flightDetails) {
    const allErrors = [];
    const allWarnings = [];
